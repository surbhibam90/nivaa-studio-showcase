...
function HomePage(){return <main>
  <section className="relative flex min-h-svh items-center overflow-hidden">
    ...
    <div className="shell relative pb-24 pt-32 md:pt-36">
      <Reveal><Eyebrow>Interior Design Studio</Eyebrow><h1 className="display-xl text-shadow-sm">Beautiful<br/>Spaces<br/><em>Brighter</em> Lives</h1><p className="hidden mt-7 max-w-sm text-sm leading-7 text-muted-foreground">We design soulful, functional and timeless spaces that reflect your story.</p><div className="mt-7"><Link to="/portfolio" className="inline-flex items-center gap-3 rounded-full bg-primary py-2.5 pr-2.5 pl-5 text-sm text-primary-foreground">Explore Our Work <span className="grid size-8 place-items-center rounded-full bg-background text-foreground"><ArrowRight className="size-4"/></span></Link></div>
